...
//
// ============================================================================
package org.talend.designer.tutorials.i18n;
...
public class Messages extends MessagesCore {
    ...
    public static String getString(final String key) {
        return getString(key, TutorialsPlugin.PLUGIN_ID, resourceBundle);
    }
    ...
    public static String getString(final String key, final Object... args) {
        return MessagesCore.getString(key, TutorialsPlugin.PLUGIN_ID, resourceBundle, args);
    }
}
