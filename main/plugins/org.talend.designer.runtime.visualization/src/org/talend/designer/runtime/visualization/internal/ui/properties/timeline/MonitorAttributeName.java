...
/**
 * created by ldong on Mar 31, 2015 Detailled comment
 *
 */
public class MonitorAttributeName {

    public static final String HEAP_MEMORY = "Used Heap Memory";

    public static final String HEAP_MEMORY_USE = "HeapMemoryUsage.used";
