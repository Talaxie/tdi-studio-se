...
/**
 * Migration task to rename component from tELTJDBCXXX to tELTXXX.
 *
 */

public class RenameELTJDBCComponentsMigrationTask extends AbstractJobMigrationTask {

    final String[] source = { "tELTJDBCInput", "tELTJDBCOutput", "tELTJDBCMap" };

    final String[] target = { "tELTInput", "tELTOutput", "tELTMap" };
    ...
    public ExecutionResult execute(Item item) {
        ...
        try {
            ...
            for (int i = 0; i < source.length; i++) {
                ...
                ResetComponentNameConversion renameConversion = new ResetComponentNameConversion(target[i], source[j]);
    ...
    public Date getOrder() {
        GregorianCalendar gc = new GregorianCalendar(2018, 6, 20, 12, 0, 0);
        return gc.getTime();
    }
}
