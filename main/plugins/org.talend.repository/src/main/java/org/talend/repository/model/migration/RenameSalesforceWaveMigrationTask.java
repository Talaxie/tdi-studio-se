...
public class RenameSalesforceWaveMigrationTask extends AbstractJobMigrationTask {

    final String[] source = { "tSalesforceWaveOutputBulkExec", "tSalesforceWaveBulkExec" };

    final String[] target = { "tSalesforceEinsteinOutputBulkExec", "tSalesforceEinsteinBulkExec" };
