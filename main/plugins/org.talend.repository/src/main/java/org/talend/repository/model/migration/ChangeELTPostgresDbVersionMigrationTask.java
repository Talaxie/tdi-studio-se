...
public class ChangeELTPostgresDbVersionMigrationTask extends AbstractJobMigrationTask{

    @Override
    public Date getOrder() {
        GregorianCalendar gc = new GregorianCalendar(2020, 10, 20, 18, 0, 0);
        return gc.getTime();
    }
    ...
    public ExecutionResult execute(Item item) {
        ...
        IComponentConversion defaultDBVersion = new IComponentConversion() {
            ...
            public void transform(NodeType node) {
                ...
                String dbVersion = ComponentUtilities.getNodePropertyValue(node, "DB_VERSION");
