...
public interface DbMapSqlConstants {
    ...
    public final static String LEFT_COMMENT = "/*"; //$NON-NLS-1$
    ...
    public final static String ON = "ON"; //$NON-NLS-1$

    public final static String GROUP_BY = "group by"; //$NON-NLS-1$

    public final static String GROUP_BY_PATTERN = "\\s*group\\s+by.*"; //$NON-NLS-1$
