 ...
 *
 */
public class JSONTree2SchemaDragAndDropHandler {

    private JSONTree2SchemaLinker linker;
    ...
    public JSONTree2SchemaDragAndDropHandler(JSONTree2SchemaLinker linker) {
        this.linker = linker;
