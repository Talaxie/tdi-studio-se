...
public class SQLCodeScanner extends AbstractSQLScanner {
    ...
    private static String[] fgKeywords = { "alter", //$NON-NLS-1$
            "begin", //$NON-NLS-1$
            "call", //$NON-NLS-1$
            "close", //$NON-NLS-1$
            "comment", //$NON-NLS-1$
    ...
    private static String[] sqlFunctions = { "abs", //$NON-NLS-1$
            "absval", //$NON-NLS-1$
            "acos", //$NON-NLS-1$
            "ascii", //$NON-NLS-1$
            "asin", //$NON-NLS-1$
    ...
    static String[] fgTokenProperties = { IConstants.SQL_TABLE, IConstants.SQL_COLUMS, IConstants.SQL_KEYWORD,
            IConstants.SQL_STRING, IConstants.SQL_DEFAULT };

    private VersionedWordRule fVersionedWordRule;

    // private static String[] fgTypes= { "void", "boolean", "char", "byte",
    ...
    protected synchronized List createRules() {
        ...
        UnsignedWordRule wordRule = new UnsignedWordRule(new SQLWordDetector(), token, getToken(IConstants.SQL_TABLE),
                getToken(IConstants.SQL_COLUMS), dictionary);
