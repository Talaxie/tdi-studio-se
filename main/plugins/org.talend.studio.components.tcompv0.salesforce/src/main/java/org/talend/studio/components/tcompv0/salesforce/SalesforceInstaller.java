...
//
// ============================================================================
package org.talend.studio.components.tcompv0.salesforce;
 ...
 *
 */
public class SalesforceInstaller extends BaseComponentInstallerTask {

    @Override
    protected Class<? extends BaseComponentInstallerTask> getInstallerClass() {
        return SalesforceInstaller.class;
    }
