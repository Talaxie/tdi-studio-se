 ...
 *
 */
public class ShellBatSettingPreferencePage extends AbstractScriptProjectSettingPage {
    ...
    protected String getPreferenceKey() {
        return IProjectSettingPreferenceConstants.TEMPLATE_BAT;
    }

    @Override
    protected String getHeadTitle() {
        return Messages.getString("ShellBatSettingPreferencePage_Title"); //$NON-NLS-1$
    }
