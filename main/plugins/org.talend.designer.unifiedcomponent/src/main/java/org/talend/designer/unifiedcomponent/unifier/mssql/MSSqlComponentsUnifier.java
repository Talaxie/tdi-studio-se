...
//
// ============================================================================
package org.talend.designer.unifiedcomponent.unifier.mssql;
 ...
 *
 */
public class MSSqlComponentsUnifier extends AbstractComponentsUnifier {
    ...
    public String getDisplayName() {
        return EDatabaseTypeName.MSSQL.getDisplayName();
    }
}
