...
//
//============================================================================
package org.talend.designer.unifiedcomponent.unifier.exasol;
...
*
*/
public class ExasolComponentsUnifier extends AbstractComponentsUnifier {
 ...
 public String getDisplayName() {
     return EDatabaseTypeName.EXASOL.getDisplayName();
 }
}
