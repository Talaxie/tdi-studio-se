...
import org.talend.designer.core.generic.controller.SchemaReferenceController;
 ...
 *
 */
public class SchemaReferenceGenerator implements IControllerGenerator {

    private IDynamicProperty dp;

    @Override
    public AbstractElementPropertySectionController generate() {
        return new SchemaReferenceController(dp);
    }
