...
import org.talend.designer.core.generic.controller.ButtonController;
 ...
 *
 */
public class ButtonGenerator implements IControllerGenerator {

    private IDynamicProperty dp;

    @Override
    public AbstractElementPropertySectionController generate() {
        return new ButtonController(dp);
    }
