...
import org.talend.designer.core.generic.controller.NameAndLabelsTreeController;
 ...
 *
 */
public class NameAndLabelsTreeGenerator implements IControllerGenerator {

    private IDynamicProperty dp;

    @Override
    public AbstractElementPropertySectionController generate() {
        return new NameAndLabelsTreeController(dp);
    }
