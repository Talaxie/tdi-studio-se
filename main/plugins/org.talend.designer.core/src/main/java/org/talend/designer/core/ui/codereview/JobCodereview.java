...
/**
 * A job codereview provides navigations between a job and its resolved superjobs and subjobs for a specific job.
 */
public class JobCodereview {

    /**
     * The job the codereview was specifically computed for, possibly null.
     */
    protected IProcess2 focusProcess;

    /**
     * DOC bqian JobCodereview constructor comment.
     */
    public JobCodereview(IProcess2 process) {
