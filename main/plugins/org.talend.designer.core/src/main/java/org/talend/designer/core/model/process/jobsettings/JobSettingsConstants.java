...
public final class JobSettingsConstants {
    ...
    private static final String[] JAVA_DB_INPUT_COMPONENTS = new String[] {
            ...
            "tPostgresqlInput", "tDB2Input", "tSybaseInput", "tIngresInput", "tSQLiteInput", "tFirebirdInput", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
    ...
    public static final String[] JAVA_DB_OUTPUT_COMPONENTS = new String[] {
            ...
            ORACLE_OUTPUT_OCI_ALIAS, "tPostgresqlOutput", "tDB2Output", "tSybaseOutput", "tIngresOutput", "tSQLiteOutput", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
