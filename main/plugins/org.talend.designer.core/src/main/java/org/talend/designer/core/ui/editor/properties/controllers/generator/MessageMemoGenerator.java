...
import org.talend.designer.core.ui.editor.properties.controllers.MessageMemoController;

/**
 * DOC zli class global comment. Detailled comment <br/>
 *
 */
public class MessageMemoGenerator implements IControllerGenerator {
    ...
    public AbstractElementPropertySectionController generate() {
        return new MessageMemoController(dp);
    }
