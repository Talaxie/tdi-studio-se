 ...
 */
public class CodereviewDependencyViewerProvider extends LabelProvider implements IStructuredContentProvider {
    ...
    public CodereviewDependencyViewerProvider(JobCodereviewLifeCycle lifeCycle) {
