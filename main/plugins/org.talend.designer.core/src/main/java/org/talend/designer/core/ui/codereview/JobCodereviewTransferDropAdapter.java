 ...
 */
public class JobCodereviewTransferDropAdapter implements TransferDropTargetListener {

    private IJobCodereviewViewPart part;

    public JobCodereviewTransferDropAdapter(IJobCodereviewViewPart part) {
        this.part = part;
    }
