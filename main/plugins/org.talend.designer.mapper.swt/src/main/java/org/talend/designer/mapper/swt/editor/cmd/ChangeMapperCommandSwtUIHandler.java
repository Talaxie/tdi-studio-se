...
public class ChangeMapperCommandSwtUIHandler extends AbsCmdSwtUIHandler implements IChangeMetadataCommandUIHandler {

    public ChangeMapperCommandSwtUIHandler() {
