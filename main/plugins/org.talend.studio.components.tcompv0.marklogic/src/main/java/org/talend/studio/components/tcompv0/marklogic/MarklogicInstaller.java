...
//
// ============================================================================
package org.talend.studio.components.tcompv0.marklogic;
 ...
 *
 */
public class MarklogicInstaller extends BaseComponentInstallerTask {

    @Override
    protected Class<? extends BaseComponentInstallerTask> getInstallerClass() {
        return MarklogicInstaller.class;
    }
